...
class BotConfig:
    ...
    DEFAULT_CONFIG = {
        ...
        # Market Parameters (user spec: minimum 30 crypto pairs under $1)
        "symbols": [
            # Major cryptos under $1
            "DOGE/USDT", "SHIB/USDT", "PEPE/USDT", "BOME/USDT", "FLOKI/USDT",
            "ADA/USDT", "XRP/USDT", "MATIC/USDT", "TRX/USDT", "VET/USDT",
            "HBAR/USDT", "ALGO/USDT", "XLM/USDT", "IOTA/USDT", "ONE/USDT",
            "HOT/USDT", "WIN/USDT", "BTT/USDT", "ANKR/USDT", "COTI/USDT",
            "REEF/USDT", "CELR/USDT", "DENT/USDT", "RVN/USDT", "SC/USDT",
            "ZIL/USDT", "ENJ/USDT", "MANA/USDT", "SAND/USDT", "CHZ/USDT",
            # Additional pairs to ensure 30+ minimum
            "1000LUNC/USDT", "1000SHIB/USDT", "1000PEPE/USDT", "1000FLOKI/USDT", "1000BONK/USDT"
        ],
